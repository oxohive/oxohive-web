...
export default function CTA() {
  return (
    <section id="contact" className="relative isolate overflow-hidden bg-screen py-[clamp(48px,8vw,104px)]">
      ...
      <div className="brand-content mx-auto w-full max-w-[1180px] px-[clamp(20px,5vw,48px)]">
        <Reveal>
          <div className="mx-auto max-w-[640px] rounded-2xl bg-white/90 p-6 text-center md:p-8">
            ...
            <h2 className="brand-text my-4 text-[clamp(27px,6.4vw,60px)] font-semibold tracking-[-.035em]">{cta.title}</h2>
